...
export type RuntimeEnv = {
  ...
  CSMONEY_PRICE_CACHE_TTL_SECONDS?: string;
  CSMONEY_PRICE_CURRENCY?: string;
...
export function runtimeEnv(): RuntimeEnv {
  return {
    ...
    CSMONEY_API_BASE_URL: process.env.CSMONEY_API_BASE_URL,
    CSMONEY_API_KEY: process.env.CSMONEY_API_KEY,
    CSMONEY_PRICE_CACHE_TTL_SECONDS: process.env.CSMONEY_PRICE_CACHE_TTL_SECONDS,
    CSMONEY_PRICE_CURRENCY: process.env.CSMONEY_PRICE_CURRENCY,
